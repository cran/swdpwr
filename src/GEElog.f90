function LogPower_GEE(mu, beta, gamma,rho0, II, JJ, KK, &
  ...
  ! II/(JJ-1). By design, II is a multiple of (JJ-1)
    ...
    double precision :: bm2(JJ*KK,JJ*KK),bm3(JJ*KK,JJ*KK),Wsub4(JJ+1,JJ)
    double precision :: B2(JJ*KK,JJ*KK),B3(JJ*KK,JJ*KK)
    double precision :: invR(JJ*KK,JJ*KK),Omega(JJ+1,JJ+1),Ry(JJ+1),Wsub2(JJ,JJ)
